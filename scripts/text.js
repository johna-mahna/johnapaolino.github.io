export let text = {
  "process": {
    "general": "I have developed a range of techniques to help lead an effective product design process. Great products involve design decisions at a number of nested layers. I see myself as a facilitator helping stakeholders realize the best solutions. Depending on the scale of the project and team, I adapt my tooling towards artifacts that will best bridge the gap between design and development. I have found value in separating the stages of the process into the following main concerns.",
    "research": "The goal of research is to identify the blocks of the user. I utilize a number of collaborative activities that help users guide me in understanding their needs. Defining and articulating the design problem is critical to the downstream success of the project. I usually find discussions over SwimLane Diagrams to be the most successful because it helps maintain a more generic representation of the problem without leaping to experience solutions.",
    "ideas": "I am a big believer in sharing early and often. I deliver rough ideas back to users and stakeholders as quickly as possible. The goal of this phase of the design is to communicate the most succinct solutions so that we can build consensus.",
    ...
    "execute": "By this point, there is a clear direction and specs can focus on micro-interaction details. If this process is executed successfully, engineers and product alike are not overloaded by specs."
  },
  "projects": {
    "general": "At Yieldbot, I have been deeply involved not only in design but also front-end implementation of our applications. I find huge value in having awareness of the different implementation cut points. This technical understanding helps inform my design decisions as well as facilitate an enjoyable ease of communication among the developers I work with.",
    ...
    "pub": "I worked to design a new publisher account management tool. The original interface lacked validation around basic model changes, leading to mistakes capable of compromising client relationships. The new application design aimed to introduce clear safety measures around all configuration interactions as well as familiar navigation patterns.",
  ...
  "brand": {
    ...
    "guide": "The work I have done establishing Yieldbot’s aesthetic is now translating nicely into our interface products. Lately, I have been focusing effort on a front-end style guide. Having been a member of the front-end team, I am aiming at a solution that is easy for developers to integrate into our build process."
  },
  "about": {
    "architecture": "At Yale, I majored in architecture. Where academic papers were so often shared privately with professors, architecture projects were presented to the entire class. The rigor required to reach this level of completion challenged the limits of my creativity while forcing clear execution.",
    ...
    "yieldbot": "Although I loved architecture, I realized the 7-10 year timelines of the projects I worked on didn’t match my creatively appetite. Fortunately, a lot of the design thinking of architecture translated to user experience and product design. The same creativity, analysis and design rigor existed, now in two dimensional plane and a quicker iterative loop. Architecture projects took years to reach construction documents. I was quickly dazzled working in tech as I saw ideas transform into code in such rapid cycles. ",
